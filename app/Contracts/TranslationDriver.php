...
interface TranslationDriver
{
    ...
    /**
     * This method is used for fetching a game's translations.
    ...
    /**
     * This method returns an array of all the languages that a particular game has translations in.
     *
     * @param \Illuminate\Database\Eloquent\Model $model
     * @return array
     */
    ...
    /**
     * Return an array of all the game instance identifiers (usually ID's) available in the provided language.
     ...
     * This is the method being called when a game is being persisted.
     *
     * @param \Illuminate\Database\Eloquent\Model $model
     * @param string $language
     * @param array $translations
    ...
    /**
     * Delete all translations for a game.
     *
     * @param \Illuminate\Database\Eloquent\Model $model
     * @return bool
     */
    ...
    /**
     * Delete all translations for a game in specified languages.
     *
     * @param \Illuminate\Database\Eloquent\Model $model
    ...
    /**
     * Delete specific attributes for a game.
