...
// JavaScript
mix.copy('resources/js/jquery-3.3.1.min.js', 'public/js').version();
mix.copy('resources/js/device.js', 'public/js').version();
mix.copy('resources/plugins/jquery.mask.min.js', 'public/js').version();
mix.copy('resources/plugins/fancybox/jquery.fancybox.min.js', 'public/js/plugins/fancybox').version();
mix.copy('resources/plugins/swiper10/swiper-bundle.min.js', 'public/js/plugins/swiper10').version();
mix.copy('resources/js/core.js', 'public/js').version();
